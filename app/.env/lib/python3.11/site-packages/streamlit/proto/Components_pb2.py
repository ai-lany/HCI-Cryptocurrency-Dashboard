...
_COMPONENTINSTANCE = DESCRIPTOR.message_types_by_name['ComponentInstance']
_SPECIALARG = DESCRIPTOR.message_types_by_name['SpecialArg']
_ARROWDATAFRAME = DESCRIPTOR.message_types_by_name['ArrowDataframe']
_ARROWTABLE = DESCRIPTOR.message_types_by_name['ArrowTable']
_ARROWTABLESTYLER = DESCRIPTOR.message_types_by_name['ArrowTableStyler']
