...
_PAGECONFIG = DESCRIPTOR.message_types_by_name['PageConfig']
_PAGECONFIG_MENUITEMS = _PAGECONFIG.nested_types_by_name['MenuItems']
_PAGECONFIG_LAYOUT = _PAGECONFIG.enum_types_by_name['Layout']
_PAGECONFIG_SIDEBARSTATE = _PAGECONFIG.enum_types_by_name['SidebarState']
