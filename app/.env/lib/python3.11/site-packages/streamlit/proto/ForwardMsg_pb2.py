...
_FORWARDMSGMETADATA = DESCRIPTOR.message_types_by_name['ForwardMsgMetadata']
_ELEMENTDIMENSIONSPEC = DESCRIPTOR.message_types_by_name['ElementDimensionSpec']
_FORWARDMSG_SCRIPTFINISHEDSTATUS = _FORWARDMSG.enum_types_by_name['ScriptFinishedStatus']
